package io.github.cottonmc.assembly.container.widget;
...
public class GeneratorButtonWidget extends ButtonWidget {
	...
	public GeneratorButtonWidget(int id, int x, int y, String name) {
		super(id, x, y, 16, 16, name);
		tex = new Identifier("assembly:textures/gui/button_"+name+".png");
		this.visible = true;
	}
